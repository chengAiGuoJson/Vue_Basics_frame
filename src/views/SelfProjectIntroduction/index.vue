...
const { projectIntroductionList } = useSceneCaseDemo();
const currentCase = shallowRef(projectIntroductionList.value[0]);
...
<template>
  <div class="scene-case-demo">
    <div class="directory-wrapper">
      ...
      <ul>
        <li
          v-for="item in projectIntroductionList"
          :key="item.title"
    ...
    <div class="content-wrapper">
      <div va_if="currentCase">
        <h2 class="font-600">{{ currentCase.title }}</h2>
