import{d as v,H as u}from"./index-CeFoSTho.js";import{d as p,B as g,o as h,v as f,c as t,a as n,b as s,a0 as _,_ as m,r as y,y as S,g as D,F as M,f as w,C as V,t as b,z as l,aa as x}from"./index-nxSPgvv3.js";const B=["innerHTML"],k=p({__name:"markDownVue",props:{bigMd:{type:String,default:""}},setup(c){const i=c,o=g(()=>v.parse(i.bigMd)),a=()=>{_(()=>{u.highlightAll()})};return h(()=>{a()}),f(o,()=>{a()}),(e,r)=>(n(),t("div",null,[s("div",{class:"markdown-body mt-16px",innerHTML:o.value},null,8,B)]))}}),C=m(k,[["__scopeId","data-v-f14dc452"]]),E=`### 批量请求数据并增量渲染 ECharts 图表\r
\r
\`\`\`\r
// series配合修改\r
{\r
