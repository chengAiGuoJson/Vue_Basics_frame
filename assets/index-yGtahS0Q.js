import{d as v,H as u}from"./index-CsNAC9IB.js";import{d as p,A as g,o as h,v as f,c as t,a as e,b as s,$ as _,_ as m,r as S,y,g as D,F as M,f as b,B as w,t as V,z as l,a9 as x}from"./index-Tsy2-O-y.js";const B=["innerHTML"],k=p({__name:"markDownVue",props:{bigMd:{type:String,default:""}},setup(c){const i=c,o=g(()=>v.parse(i.bigMd)),a=()=>{_(()=>{u.highlightAll()})};return h(()=>{a()}),f(o,()=>{a()}),(n,r)=>(e(),t("div",null,[s("div",{class:"markdown-body mt-16px",innerHTML:o.value},null,8,B)]))}}),E=m(k,[["__scopeId","data-v-f14dc452"]]),I=`### 批量请求数据并增量渲染 ECharts 图表\r
\r
\`\`\`\r
// series配合修改\r
{\r
